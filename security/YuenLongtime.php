    ...
    <div class="container">
        ...
        <div class="right-content">
            ...
            <div class="time-slots">
                <button class="time-btn">上午 9:15</button>
                <button class="time-btn">上午 9:30</button>
                <button class="time-btn">上午 9:45</button>
                <button class="time-btn">上午 10:15</button>
                <button class="time-btn">上午 10:30</button>
                <button class="time-btn">上午 10:45</button>
                <button class="time-btn">上午 11:00</button>
                <button class="time-btn">上午 11:15</button>
                <button class="time-btn">上午 11:30</button>
                <button class="time-btn">上午 11:45</button>
                <button class="time-btn">中午 12:00</button>
                <button class="time-btn">下午 12:15</button>
                <button class="time-btn">下午 2:15</button>
                <button class="time-btn">下午 2:30</button>
                <button class="time-btn">下午 2:45</button>
                <button class="time-btn">下午 3:00</button>
                <button class="time-btn">下午 3:15</button>
                <button class="time-btn">下午 3:30</button>
                <button class="time-btn">下午 3:45</button>
            </div>
        ...
        <script>
            (function(){
                // Read the displayed date from the page (fallbacks if PHP variable isn't present)
                var dateEl = document.querySelector('.date-display');
                var selectedDate = dateEl ? dateEl.textContent.trim() : '';

                var OFFICE_SLUG = 'yuenlong';
                var OFFICE_ADDRESS = '元朗辦事處 元朗橋樂坊2號元朗政府合署1樓';

                // Attach to the actual button class used in this file
