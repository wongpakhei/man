...
<head>
    ...
    <style>
        ...
        .calendar .closed {
            background: #ffcccc; /* 滿額/不可選背景 */
            color: #999;
        }

        .calendar .available {
            background: #ffaa00; /* 可選背景 */
            color: #fff;
            cursor: pointer;
        }

        .calendar .available:hover {
            background: #ff8800; /* 懸停強化 */
        }

        .calendar .gray {
            background: #e6e6e6; /* 不可選日期背景 */
            color: #999;
        }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="right-content">
            ...
            (function(){
                ...
                // identify this office so email.php can display address
                const OFFICE_SLUG = 'wanchai';
                const OFFICE_ADDRESS = '港島辦事處 灣仔告士打道7號入境事務大樓8樓';
                ...
                var monthText = header ? header.textContent.trim() : '';                
                    ...
                    var url = 'email.php?date=' + encodeURIComponent(dateStr) + '&office=' + encodeURIComponent(OFFICE_SLUG) + '&officeAddress=' + encodeURIComponent(OFFICE_ADDRESS);
