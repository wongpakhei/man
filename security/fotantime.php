<?php
// 模拟选定的日期与可预约时间段（可根据业务逻辑从数据库等动态获取）
$selectedDate = "2025年11月10日 (星期一)";
$timeSlots = [
    "上午 9:30", "上午 9:45", "上午 10:15", "上午 10:45",
    "上午 11:00", "上午 11:15", "上午 11:30", "上午 11:45",
    "中午 12:00", "下午 12:15", "下午 2:15", "下午 2:30",
...
<head>
    ...
    <style>
        * {
        ...
        .back-button:hover {
            background-color: #4a3a2c; /*  hover 時加深顏色 */
        }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="location-section">
                <h3>選擇日期與時間</h3>
                <p>辦事處</p>
                <p>火炭辦事處 火炭樂景街2至18號銀禧薈4樓405至407號舖位</p>
                <a href="#">位置地圖</a>
            </div>
         ...
         <script>
            (function(){
                ...
                // 為所有時段按鈕加入點擊事件，點擊後導向 email.php 並帶上日期與時段參數
                var buttons = document.querySelectorAll('.time-slot');
                var OFFICE_SLUG = 'fotan';
                var OFFICE_ADDRESS = '火炭辦事處 火炭樂景街2至18號銀禧薈4樓405至407號舖位';
                buttons.forEach(function(btn){
                    btn.addEventListener('click', function(){
                        var slot = btn.textContent || btn.innerText;
